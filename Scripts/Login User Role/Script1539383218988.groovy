...
WebUI.setText(findTestObject('Page_Rubica/input__email'), 'ryanrubica+portalautouser1@gmail.com')
...
WebUI.verifyTextPresent('This user is not allowed to login.', false)
