...
Mobile.tap(findTestObject('android.widget.TextView20 - DEVICES'), 0)

Mobile.tap(findTestObject('android.widget.TextView30 - THREATS'), 0)

Mobile.tap(findTestObject('android.widget.TextView3 - UnderInvestigation'), 0)

Mobile.tap(findTestObject('android.widget.TextView2 - Blocked'), 0)

Mobile.tap(findTestObject('android.widget.TextView5 - STATUS'), 0)
